    ...
    data() {
        return {
            ...
            distributionTabsMapOptions: [
                {
                    label: this.$t("views.apps.simon.exploration.components.tabs.distributionTab.index.tabs.distributionTraining.title"),
                    view: "distributionTraining",
                    key: "distributionTraining",
                    icon: "fa fa-balance-scale",
                },
                {
                    label: this.$t("views.apps.simon.exploration.components.tabs.distributionTab.index.tabs.distributionTesting.title"),
                    view: "distributionTesting",
                    key: "distributionTesting",
                    icon: "fa fa-balance-scale",
                },
                {
                    label: this.$t("views.apps.simon.exploration.components.tabs.distributionTab.index.tabs.distributionResample.title"),
