        ...
        <el-row>
            <el-col :span="11">
                <el-card class="box-card">
                    <div slot="header">
                        {{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.head.available.title") }}
                                ...
                                >
                                    ...
                                    <div class="draggable-item-content-wrap">
                                        <ul class="general_info">
                                            <li>
                                                <span class="title">{{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.containers.method_type.title") }}:</span>
                                                <span class="desc">
                                                    <span v-if="item.classification == 1">
                                                        {{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.containers.method_type.classification") }}
                                                    </span>
                                                    <span v-if="item.regression == 1">
                                                        {{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.containers.method_type.regression") }}
                                                    </span>
                                                </span>
            ...
            <el-col :span="11" :push="2">
                <el-card class="box-card">
                    <div slot="header">
                        {{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.head.selected.title") }}
                    ...
                    <div class="box-item">
                        <div style="float: left; height: 36px; line-height: 36px">
                            <el-tooltip placement="top">
                                <div slot="content">
                                    {{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.head.selected.extraction.description") }}
                                </div>
                                <span class="field-label">{{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.head.selected.extraction.title") }}</span>
                            </el-tooltip>
                        ...
                        <div style="float: right; height: 36px; line-height: 36px">
                            <el-tooltip placement="top">
                                <div slot="content">
                                    {{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.head.selected.feature_selection.description") }}
                                </div>
                                <span class="field-label">{{ $t("views.apps.supervised_learning.analysis.components.PackageSelection.head.selected.feature_selection.title") }}</span>
                            </el-tooltip>
