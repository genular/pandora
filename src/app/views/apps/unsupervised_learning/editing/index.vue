...
export default {
    ...
    data() {
        return {
            ...
            tabMapOptions: [
                {
                    label: this.$t("views.apps.simon.unsupervised_learning.components.tabs.overviewTab.title"),
                    key: "overviewTab",
                    icon: "el-icon-date",
                },
                {
                    label: this.$t("views.apps.simon.unsupervised_learning.components.tabs.correlationTab.title"),
                    key: "correlationTab",
                    icon: "el-icon-date",
                ...
                {
                    label: this.$t("views.apps.simon.unsupervised_learning.components.tabs.clusteringTab.title"),
                    key: "clusteringTab",
                    icon: "el-icon-date",
                    restriction: "selectedFileDetails",
                    restriction_details: -1,
                ...
                {
                    label: this.$t("views.apps.simon.unsupervised_learning.components.tabs.pcaAnalysisTab.title"),
                    key: "pcaAnalysisTab",
                    icon: "el-icon-date",
                    restriction: "selectedFileDetails",
                    restriction_details: -1,
                ...
                {
                    label: this.$t("views.apps.simon.unsupervised_learning.components.tabs.tSNETab.title"),
                    key: "tSNETab",
                    icon: "el-icon-date",
                    restriction: "selectedFileDetails",
                    restriction_details: -1,
                ...
                {
                    label: this.$t("views.apps.simon.unsupervised_learning.components.tabs.umapTab.title"),
                    key: "umapTab",
                    icon: "el-icon-date",
                    restriction: "selectedFileDetails",
                    restriction_details: -1,
